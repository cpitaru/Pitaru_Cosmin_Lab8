...
namespace Pitaru_Cosmin_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Pitaru_Cosmin_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Pitaru_Cosmin_Lab8Context context,
